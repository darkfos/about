...
import { TitleText, HorizontalCard, TypographyText } from '@/shared/ui'

import { BackendCategoryIcon, FrontendCategoryIcon, OtherCategoryIcon } from '@/shared/ui'
</script>
          ...
          <HorizontalCard title-text="Backend" title-icon-alt="Иконка бекенда">
            ...
            <template #description>
              <TypographyText type="p">
                ...
                <TypographyText type="span" id="select-text">NodeJS</TypographyText>. Из фреемворков
                активно использую
          ...
          <HorizontalCard title-text="Other" title-icon-alt="Иконка бекенда">
            ...
            <template #description>
              <TypographyText type="p">
                ...
                <TypographyText type="span" id="select-text">Docker/docker-compose</TypographyText>,
